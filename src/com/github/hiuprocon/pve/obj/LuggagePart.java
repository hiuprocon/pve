...
public class LuggagePart extends PVEPart {
	...
	protected CollisionShape makeCollisionShape() {
		...
		BoxShape centerBox = new BoxShape(new Vector3f(1.5f/2.0f,0.5f/2.0f,0.5f/2.0f));
		Transform localTrans = new Transform();
		localTrans.setIdentity();
		compound.addChildShape(localTrans,centerBox);
		BoxShape rightBox = new BoxShape(new Vector3f(0.2f/2.0f,1.5f/2.0f,1.5f/2.0f));
		localTrans.setIdentity();
		localTrans.origin.set(0.95f,0,0);
		compound.addChildShape(localTrans,rightBox);
		BoxShape leftBox = new BoxShape(new Vector3f(0.2f/2.0f,1.5f/2.0f,1.5f/2.0f));
		localTrans.setIdentity();
		localTrans.origin.set(-0.95f,0,0);
