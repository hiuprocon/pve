...
public class ForkLift extends PVEObject {
	...
	protected PVEPart[] createParts() {
		...
		lift = new Box(Type.DYNAMIC,0.1,new Vector3d(1.0,2.0,0.1),"x-res:///res/ClearBox.wrl");
		fork = new Box(Type.DYNAMIC,0.1,new Vector3d(1.0,0.1,1.0),"x-res:///res/ClearBox.wrl");
