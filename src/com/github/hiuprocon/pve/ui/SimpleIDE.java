...
public class SimpleIDE extends JDialog implements ActionListener {
    ...
    public SimpleIDE(Frame owner) {
        ...
        messages = ResourceBundle.getBundle(
                "com.github.hiuprocon.pve.ui.Messages", pc);
    ...
    void prepareJars() {
        ...
        if (!vpF.exists()) {
            ...
            boolean b = dl(
                    "http://acerola3d.sourceforge.jp/jws/acerola3d/all/vecmath.jar",
                    vecmathPath);
            if (b)
    ...
    void makeJarFileRec(JarOutputStream jos, File f, String path)
            throws Exception {
        if (f.isDirectory()) {
