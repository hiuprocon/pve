...
/**
 * Acerola3DのSimpleControllerをコピーしてマウスの左と真ん中のボタンを 替えただけ。
 */
public class A3CSController extends A3Controller {
    // 注視点
    ...
    public void mouseDragged(A3Event ae) {
        ...
        if ((me.getModifiersEx() & MouseEvent.BUTTON2_DOWN_MASK) != 0) {
            ...
            Tuple3d shift = a3canvas.canvasToPhysicalCS(lastMouseX, lastMouseY,
                    -v.z);
