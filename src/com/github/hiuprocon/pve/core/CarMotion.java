...
class CarMotion implements Motion {
    ...
    // public CarMotion(MotionState ms,DefaultVehicleRaycaster
    // vehicleRayCaster,RigidBody body) {
    public CarMotion(MotionState ms, PVEWorld world, RigidBody body) {
        ...
        // create vehicle
        {
            ...
            DefaultVehicleRaycaster vehicleRayCaster = world
                    .createDefaultVehicleRaycaster();
            ...
            vehicle.addWheel(connectionPointCS0, wheelDirectionCS0,
    ...
    // public RigidBody localCreateRigidBody(float mass, Transform
    // startTransform, CollisionShape shape) {
    public RigidBody localCreateRigidBody(float mass, MotionState ms,
    ...
    static final String cbs[] = { "chassis", "frontRight", "frontLeft",
            "rearRight", "rearLeft" };
    ...
    static final String abs[] = { "root", "chassis", "frontRight", "frontLeft",
            "rearRight", "rearLeft" };
