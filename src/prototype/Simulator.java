...
public class Simulator implements CollisionListener {
    ...
    public Simulator() throws Exception {
        ...
        ground = new BoxObj(Type.STATIC,0,new Vector3d(250,1,100),"x-res:///res/prototype/Ground.wrl");
        ground.setUserData("ground");
        ground.setLocRev(0,-0.5,0, 0,0,0);
        w.add(ground);

        wall1 = new BoxObj(Type.STATIC,0,new Vector3d(5,5,100),"x-res:///res/Box.wrl");
        wall1.setUserData("wall1");
        wall1.setLocRev(-25,2.51,0, 0,0,0);
        w.add(wall1);

        wall2 = new BoxObj(Type.STATIC,0,new Vector3d(5,5,100),"x-res:///res/Box.wrl");
        ...
        switch1 = new BoxObj(Type.GHOST,1,new Vector3d(10,1,10),"x-res:///res/ClearBox.wrl");
        switch1.setUserData("switch1");
        switch1.setLocRev(-17.49,0.51,10, 0,0,0);
        w.add(switch1);

        switch2 = new BoxObj(Type.GHOST,1,new Vector3d(10,1,10),"x-res:///res/ClearBox.wrl");
        switch2.setUserData("switch2");
        switch2.setLocRev(17.49,0.51,-10, 0,0,0);
        w.add(switch2);

        goal1 = new BoxObj(Type.GHOST,1,new Vector3d(20,1,10),"x-res:///res/ClearBox.wrl");
        goal1.setUserData("goal1");
        goal1.setLocRev(0,0.51,45, 0,0,0);
        w.add(goal1);

        goal2 = new BoxObj(Type.GHOST,1,new Vector3d(20,1,10),"x-res:///res/ClearBox.wrl");
        goal2.setUserData("goal2");
        goal2.setLocRev(0,0.51,-45, 0,0,0);
        w.add(goal2);

        obstacle1 = new Obstacle(new Vector3d(0,0.5,10),new Vector3d(-0.3,0,0.3));
        obstacle1.setUserData("obstacle1");
        w.add(obstacle1);

        obstacle2 = new Obstacle(new Vector3d(0,0.5,-10),new Vector3d(0.4,0,-0.5));
    ...
    public void collided(PVEPart a, PVEPart b) {
        ...
        if (aa==switch1 && bb==carB) elevator1.setUp();
        if (aa==carB && bb==switch1) elevator1.setUp();
        if (aa==switch2 && bb==carB) elevator2.setUp();
        if (aa==carB && bb==switch2) elevator2.setUp();
