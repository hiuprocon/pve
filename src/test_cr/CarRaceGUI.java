...
class CarRaceGUI extends JFrame implements ActionListener {
    ...
    CarRaceGUI(CarRaceImpl i, String carClass) {
        ...
        messages = ResourceBundle.getBundle("test_cr.Messages", pc);
    ...
    void setCar(CarBase c) {
        ...
        carCanvas.setNavigationMode(A3CanvasInterface.NaviMode.CHASE, lookAt,
                camera, up, 10.0);
    }
    ...
    void changeCP() {
        Object[] possibleValues = { i18n("ccp.onlySystem"),
                i18n("ccp.workingFolder"), i18n("ccp.jarFile") };
        Object iniVal;
        ...
        String selectedValue = (String) JOptionPane.showInputDialog(this,
                i18n("ccp.whereLoadFrom"), "Input",
                JOptionPane.INFORMATION_MESSAGE, null, possibleValues, iniVal);
    ...
    void conf() {
        Object[] possibleValues = { i18n("conf.workingFolder"),
                i18n("conf.cameraTracking") };
        String selectedValue = (String) JOptionPane.showInputDialog(this,
        ...
        if (selectedValue.equals(possibleValues[0])) {
            ...
            try {
                ...
                camera.scale(cameraDist);
                Vector3d up = new Vector3d(0.0, 1.0, 0.0);
                carCanvas.setNavigationMode(A3CanvasInterface.NaviMode.CHASE,
                        lookAt, camera, up, 10.0);
                val = JOptionPane.showInputDialog(this,
                        i18n("conf.interpolation"), "0.1");
                if (val == null)
                    return;
