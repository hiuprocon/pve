...
public class TestCar03 extends BattleCarBase {
    ...
    { 0, 0, -2 }, { 2, 0, 0 }, { 0, 0, 2 }, { -2, 0, 0 }, { -8.5, 0, 8.5 },
            { -8.5, 0, 11.5 }, { -11.5, 0, 11.5 }, { -11.5, 0, 8.5 },
            { 8.5, 0, -8.5 }, { 8.5, 0, -11.5 }, { 11.5, 0, -11.5 },
            { 11.5, 0, -8.5 }, { -17.5, 0, 7.5 }, { -17.5, 0, 10.5 },
            { -17.5, 0, 13.5 }, { -17.5, 0, 16.5 }, { -26.0, 0, 7.5 },
            { -26.0, 0, 10.5 }, { -26.0, 0, 13.5 }, { -26.0, 0, 16.5 },
            { -20.5, 0, 7.5 }, { -23.5, 0, 7.5 }, { -20.5, 0, 16.5 },
            { -23.5, 0, 16.5 }, { -14.5, 0, 20.0 }, { -14.5, 0, 20.0 },
            { -14.5, 0, 20.0 }, { -14.5, 0, 20.0 }, { -14.5, 0, 20.0 },
            { -14.5, 0, 20.0 }, { -14.5, 0, 20.0 }, { -14.5, 0, 20.0 } };
