...
public class Demo implements CollisionListener {
    ...
    public static void main(String args[]) {
        ...
        // ground = new BoxObj(Type.STATIC,0,new
        // Vector3d(100,1,100),"x-res:///res/background0.wrl");g.setLocRev(0,-0.5,0,
        // 0,0,0);
        w.add(ground);
        ...
        // BoxObj b = new BoxObj(Type.DYNAMIC,1,new
        // Vector3d(1,2,1),"x-res:///res/Box.wrl");
