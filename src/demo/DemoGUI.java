...
public class DemoGUI extends JFrame implements ChangeListener {
	...
	public DemoGUI(A3Canvas c) {
	    ...
	    c.setNavigationMode(A3CanvasInterface.NaviMode.CHASE,lookAt,camera,up,1.0);
	    c.setSize(500,300);
	    add(c);
	    ...
	    p.add(b);
	    aRB=new JRadioButton("A");aRB.addChangeListener(this);b.add(aRB);
	    bRB=new JRadioButton("B");bRB.addChangeListener(this);b.add(bRB);
	    cRB=new JRadioButton("C");cRB.addChangeListener(this);b.add(cRB);
	    dRB=new JRadioButton("D");dRB.addChangeListener(this);b.add(dRB);
	    eRB=new JRadioButton("E");eRB.addChangeListener(this);b.add(eRB);
	    fRB=new JRadioButton("F");fRB.addChangeListener(this);b.add(fRB);
	    gRB=new JRadioButton("G");gRB.addChangeListener(this);b.add(gRB);
	    ButtonGroup bg = new ButtonGroup();
	    bg.add(aRB);bg.add(bRB);bg.add(cRB);bg.add(dRB);bg.add(eRB);bg.add(fRB);bg.add(gRB);
	    add(p);
